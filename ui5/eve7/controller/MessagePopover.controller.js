sap.ui.define([
	...
	return Controller.extend("rootui5.eve7.controller.MessagePopover", {
		onInit: function () {
			// create any data and a model and set it to the view
			console.log("AMT message popover on init");
		...
		handleMessagePopoverPress: function (oEvent) {
			...
			model.setData(JSROOT.EVE.console);
			model.refresh();
			this.oMessagePopover.toggle(oEvent.getSource());
		},

		addInfoMessage: function(txt){
			let model = this.getView().getModel(oModel);
			model.data.push({type:'Info', title:txt});
